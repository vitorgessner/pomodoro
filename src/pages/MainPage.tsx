        ...
        <TimerContext value={state}>
            <div className="flex-center my-15">
                ...
                <div className="flex relative items-center justify-center mt-28">
                    ...
                    <svg className="absolute" width="284" height="237" viewBox="0 0 194 147" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M151.757 139.784C208.257 121.085 203.757 41.6879 156.257 25.1663C132.59 18.6266 93.8568 9.47088 40.2568 25.1663C-1.07657 42.8926 -22.2433 105 37.7568 137.5C61.7568 148 122.757 149.382 151.757 139.784Z" fill="url(#paint0_linear_55_4)" stroke="black" />
                        <path d="M109.725 68.4774C107.027 68.4774 82.7408 57.7472 85.4393 41.2393C85.4393 41.2393 84.09 35.049 55.7567 52.3821C63.852 31.3348 84.09 27.6205 84.09 27.6205C84.09 27.6205 81.3916 20.1915 61.1535 20.1916C80.0424 9.04848 92.1853 14.0007 100.281 20.1915C104.328 11.5245 123.217 11.5249 138.058 20.1916C113.773 20.1916 112.423 30.0964 112.423 32.5726C112.423 32.5726 123.217 37.5251 140.757 35.0488C134.011 40.0014 120.519 47.4295 107.027 44.9536C96.6825 52.7948 105.677 62.2869 109.725 68.4774Z" fill="url(#paint1_linear_55_4)" stroke="black" />
                        <path d="M98.9313 0.648398C106.487 4.6103 102.979 25.4103 100.28 35.3151C99.9576 36.5001 92.5415 35.3151 92.808 34.5001C95.5064 26.2461 98.4148 10.325 90.8593 4.38214C92.2104 1.86071 96.0082 -0.05933 98.9313 0.648398Z" fill="url(#paint2_linear_55_4)" stroke="black" />
                        <defs>
                            <linearGradient id="paint0_linear_55_4" x1="227.257" y1="34.9759" x2="-49.1143" y2="179.358" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#DD1010" />
                                <stop offset="1" stop-color="#961616" />
                            </linearGradient>
                            <linearGradient id="paint1_linear_55_4" x1="115.148" y1="1.87049" x2="69.8686" y2="86.0025" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#40BA46" />
                                <stop offset="1" stop-color="#1D541F" />
                            </linearGradient>
                            <linearGradient id="paint2_linear_55_4" x1="102.071" y1="6.38214" x2="79.6328" y2="9.10102" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#40BA46" />
                                <stop offset="1" stop-color="#1D541F" />
                            </linearGradient>
                        </defs>
                ...
                <ButtonContainer>
                    <span className="flex gap-2 mt-30">
                        <Button type="start"
